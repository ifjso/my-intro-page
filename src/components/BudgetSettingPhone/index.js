...
const BudgetSettingPhone = () => {
    ...
    return (
        <div className="wrap-budget-setting-phone" id="aaa" data-aos="fade-up" data-aos-id="aaa" data-aos-easing="ease-in-sine" data-aos-duration="600" data-aos-anchor-placement="top-bottom">
